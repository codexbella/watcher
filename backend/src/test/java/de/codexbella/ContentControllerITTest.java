...
class ContentControllerITTest {
   ...
   void integrationTest(@Value("${app.api.key}") String apiKey) {
      ...
      assertThat(arraySearchTwoPage[20].getApiId()).isEqualTo(132372);
      assertThat(arraySearchTwoPage[20].getName()).isEqualTo("Jules Verne's Amazing Journeys");
      assertThat(arraySearchTwoPage[21].getApiId()).isEqualTo(98570);
      assertThat(arraySearchTwoPage[21].getName()).isEqualTo("Voyages au Pays des Vins de Terroir");
